...
if(global.isServer == true) {
    ...
    if(ds_list_size(obj_controller.SocketList) > 0) {
    
        var buffer = obj_controller.Buffer;
        ...
        var Result = network_send_packet( ds_list_find_value( obj_controller.SocketList,0 ) , 
